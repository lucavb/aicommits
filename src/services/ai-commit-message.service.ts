...
export class AICommitMessageService {
    ...
    async generateAgentCommitMessageWithInstructions({
        stagedFiles,
        userInstructions,
        onStepUpdate,
        onComplete,
        ...
        const systemPrompt = this.promptService.getAgentCommitMessageWithInstructionsSystemPrompt(userInstructions);
        const userPrompt = this.promptService.getAgentCommitMessageWithInstructionsUserPrompt(
            maxLength,
            userInstructions,
        );
