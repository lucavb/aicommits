...
async function handleAgentMode(
    ...
    try {
        ...
        // For agent mode, we'll skip the review and revise flow for now
        // and directly ask for user confirmation
        const reviewResult = { accepted: true, message: result.commitMessage, body: result.body };
